    ...
    <div :class="['home', workHistory ? 'stuck': '']" :aria-hidden="workHistory ? 'true' : 'false'">
      <div class="inner">
        ...
        <section>
          ...
          <p>I also build and maintain scalable APIs with <notify-item msg="go">Go</notify-item>, <notify-item msg="node">Node.js</notify-item> or <notify-item msg="python">Python</notify-item>. Occasionally I work on <notify-item msg="browserExtensions">browser extensions</notify-item>, build <notify-item msg="sdk">SDKs</notify-item>, and publish <notify-item msg="npm">npm packages</notify-item>.</p>
